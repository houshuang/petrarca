...
# Subprocess helper for import_url.py etc. Use same interpreter as this server in Docker / dev.
...
Return ONLY valid JSON.""",
    ...
    def _handle_book_research(self):
        ...
        invalidate = bool(body.get('invalidate') or body.get('force_regenerate'))

        if invalidate:
            from book_research_agent import invalidate_book_research
            if invalidate_book_research(book_id):
